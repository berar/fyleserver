...
public class EnglishLocalizationImpl implements Localization {
	...
	@Override
	public String getUsernameIsTaken() {
	...
	public String getRegistrationComplete(){
		return "Registration is complete. Hello ";
	}
	...
	@Override
	public String getLoginWait(long sec){
		return String.format("You need to wait %d seconds.", sec);
	}
}
