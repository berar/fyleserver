...
public class AesCbc {
    ...
    public static String encrypt(final String plainMessage,
                                 final String symKeyHex, SecureRandom rnd) {
    ...
    public static boolean pwcheck(final String ivAndEncryptedMessageBase64,
                                  final String symKeyHex, final String candidate){
        if(candidate.equals(decrypt(ivAndEncryptedMessageBase64, symKeyHex))){
            return true;
        }else{
            return false;
        }
